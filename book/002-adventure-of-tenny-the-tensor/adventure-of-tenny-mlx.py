...
# Tenny now evolves into a 4-dimensional array, adding the concept of time, with the magic of mlx
# Note that, strictly speaking, MLX is not necessary for this example. NumPy is more than enough. It's included merely for enjoyment.
tenny_4d = mx.array([[[[5], [2]], [[3], [4]]]])
